...
# Required (set in Railway env vars)
...
SD_PROMPT = 'spooky dark haunted house ghost horror story cinematic dramatic lighting, 4k, detailed'
SD_NEGATIVE_PROMPT = 'blurry, low quality, text, watermark, cartoon, anime'
